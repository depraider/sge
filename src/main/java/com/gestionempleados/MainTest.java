...
public class MainTest {
  ...
  public static void main(String[] args) {
    ...
    String rutaBinario = outputDir + "/empleados.dat";

    // Guardar Binario
    gestorBinario.guardarEmpleados(rutaBinario, empleados);

    // Cargar Binario
    List<Empleado> empleadosBinario = gestorBinario.cargarEmpleados(rutaBinario);
    if (empleadosBinario != null) {
      System.out.println("Empleados cargados desde BINARIO:");
      for (Empleado e : empleadosBinario) {
        System.out.println(e);
      }
    }
  }
