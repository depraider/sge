...
public class VistaEmpleados extends javax.swing.JFrame {
        ...
        layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextField3, javax.swing.GroupLayout.PREFERRED_SIZE, 71,
  ...
  private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
    ...
    if (fila >= 0) {
      ...
      JOptionPane.showMessageDialog(this, "Seleccione un empleado para modificar", "Atención",
  ...
  private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
    ...
    if (fila >= 0) {
      ...
      JOptionPane.showMessageDialog(this, "Seleccione un empleado para eliminar", "Atención",
          JOptionPane.WARNING_MESSAGE);
    }
  ...
  private void accionGuardar() {
    // Preguntar formato
    String[] opciones = { "JSON", "XML", "GSON", "BINARIO" };
    int seleccion = JOptionPane.showOptionDialog(this, "¿En que formato quieres guardar?", "Guardar",
        JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, opciones, opciones[0]);

    if (seleccion < 0)
      return; // Si cierra la ventana

    // Elegir ruta
    JFileChooser fileChooser = new JFileChooser();
    fileChooser.setDialogTitle("Guardar fichero");

    // Configurar la extensión según la elección
    ...
    if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
      ...
      // Asegurar extensión si el usuario no la pone
      if (!ruta.endsWith(extension))
        ruta += extension;

      // llamar al gestor correspondiente
      switch (seleccion) {
